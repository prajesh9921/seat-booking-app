...
//       const sameRowSeats = available.filter(seat => seat.rownumber === currentRow).sort((a, b) => a.seatnumber - b.seatnumber);
...
//     for (let r = bestRange.start; r <= bestRange.end; r++) { // FIXED off-by-one bug
//       const rowSeats = available
//         .filter(seat => seat.rownumber === r + 1) // Because rownumber starts from 1
//         .sort((a, b) => a.seatnumber - b.seatnumber); // MODIFIED: Ensures closest seats
